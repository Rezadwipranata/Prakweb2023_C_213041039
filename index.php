...
<html lang="en">
  <head>
    ...
    <title>History Book | Katalog Buku Sejarah</title>
  </head>
  <body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
        <a class="navbar-brand" href="#">History Book</a>
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <h5 class="card-title"><?= $b['judul']; ?></h5>
                                    ...
                                    <a href="hapus.php?id=<?= $b['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('yakin ingin menghapus buku tersebut dari katalog?');">Delete</a>
                        </div>
                    </div>
                </div>
            </div>
